...
- [2. Qué es la programación asíncrona](#2-que-es-la-programacion-asincrona)
- [3. Qué es un thread](#3-que-es-un-thread)
    - [Creando un thread](#creando-un-thread)
    - [Problemas con threads](#problemas-con-threads)
    - [Background thread](#background-thread)
    - [Desventajas de crear un thread manualmente](#desventajas-de-crear-un-thread-manualmente)
- [4. Qué es el ThreadPool](#4-que-es-el-threadpool)
    - [Usando Task.Run](#usando-taskrun)
- [5. Qué es un Task](#5-que-es-un-task)
- [6. async/await: Qué son y cómo funcionan](#6-asyncawait-que-son-y-como-funcionan)
    - [Ventajas de async/await](#ventajas-de-asyncawait)
    - [La clase Task](#la-clase-task)
    - [Qué ocurre internamente cuando usamos async/await](#que-ocurre-internamente-cuando-usamos-asyncawait)
...
- [10. Buenas prácticas y errores comunes](#10-buenas-practicas-y-errores-comunes)
    - [Evitar bloqueo: .Result / .Wait](#evitar-bloqueo-result-wait)
    - [Manejo de excepciones en Tasks](#manejo-de-excepciones-en-tasks)
- [11. Cuándo y cómo usar async/await](#11-cuando-y-como-usar-asyncawait)
- [12. Clases útiles](#12-clases-utiles)
